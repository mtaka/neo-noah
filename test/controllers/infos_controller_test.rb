...
class InfosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create info" do
    assert_difference('Info.count') do
      post infos_url, params: { info: { article_id: @info.article_id, data: @info.data, data_type: @info.data_type, role: @info.role, title: @info.title } }
    end
  ...
  test "should update info" do
    patch info_url(@info), params: { info: { article_id: @info.article_id, data: @info.data, data_type: @info.data_type, role: @info.role, title: @info.title } }
